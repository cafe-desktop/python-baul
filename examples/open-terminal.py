...
class OpenTerminalExtension(Baul.MenuProvider, GObject.GObject):
    def __init__(self):
    ...
    def get_file_items(self, window, files):
        ...
        item = Baul.MenuItem(name='BaulPython::openterminal_file_item',
                                 label='Open Terminal' ,
    ...
    def get_background_items(self, window, file):
        item = Baul.MenuItem(name='BaulPython::openterminal_item',
